...
[![askai](https://img.shields.io/badge/askai-1.0.8-blue)](./askai/ASKAI%20INTEGRATION_GUIDE.md)
[![askai-ui-components](https://img.shields.io/badge/askai--ui--components-1.0.8-blue)](./askai-ui/ASKAI%20UI%20INTEGRATION_GUIDE.md)
[![rivi-ui-core](https://img.shields.io/badge/rivi--ui--core-1.0.8-blue)](./rivi-ui-core/RIVI%20UI%20INTEGRATION_GUIDE.md)
...
|---------|---------|---------|-------|
| `co.rivi:askai` | `1.0.8` | Core Ask AI search, ranking, SSE updates | [Guide →](./askai/ASKAI%20INTEGRATION_GUIDE.md) |
| `co.rivi:askai-ui-components` | `1.0.8` | Ask AI UI components (`SortFilterRow`, `AskAiSheet`) **_requires rivi-ui-core_** | [Guide →](./askai-ui/ASKAI%20UI%20INTEGRATION_GUIDE.md) |
| `co.rivi:rivi-ui-core` | `1.0.8` | **Required** theme and design system for Ask AI UI components | [Guide →](./rivi-ui-core/RIVI%20UI%20INTEGRATION_GUIDE.md) |
...
**Keep all modules at `1.0.8`** for compatibility.
